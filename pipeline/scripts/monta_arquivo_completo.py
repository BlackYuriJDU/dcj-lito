...
ESTRUTURA = [
    ...
    ("CASO REFERÊNCIA (SIMULADO) — DOSSIÊ, EXAMES, LINHA DO TEMPO E FONTES",
     ["caso_lito/dossie_clinico.md", "caso_lito/exames_simulados.csv",
      "caso_lito/linha_do_tempo.csv", "caso_lito/fontes.md",
      "pipeline/reports/relatorio_caso_lito.md"]),
    ...
    ("PONTE CASO SIMULADO × COORTE REAL",
     ["pipeline/reports/relatorio_ponte_lito_real.md"]),
    ...
    ("MATERIAL PARA FAMÍLIAS E PARA LABORATÓRIOS",
     ["colaboracao/guia_de_familias.md", "colaboracao/carta_lito.md",
      "colaboracao/carta_projeto.md", "colaboracao/centros_alvo.md"]),
    ("MEMÓRIA DO PROJETO — ERROS, DECISÕES E PADRÕES",
     ["memory/mistakes.md", "memory/decisions.md", "memory/successful-patterns.md"]),
    ("APÊNDICE A — CÓDIGO-FONTE COMPLETO DOS 7 SCRIPTS",
     ["pipeline/scripts/analise_caso_lito.py", "pipeline/scripts/analise_gse160208.py",
      "pipeline/scripts/analise_gse140069.py", "pipeline/scripts/ponte_lito_real.py",
