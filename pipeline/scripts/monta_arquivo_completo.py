...
ESTRUTURA = [
    ...
    ("COLOCALIZAÇÃO STX6 — eQTL CEREBRAL (5 COORTES, META-ANÁLISE)",
     ["pipeline/reports/relatorio_coloc_stx6.md",
      "pipeline/reports/relatorio_coloc_meta_stx6.md"]),
    ("VARREDURA CEGA GENOMA-A-DIANTE — SENSIBILIDADE DO PIPELINE",
     ["pipeline/reports/relatorio_clumping_descoberta.md"]),
    ("INTEGRAÇÃO CÉREBRO × SANGUE (miRTarBase × DEGs — NEGATIVO HONESTO)",
     ["pipeline/reports/relatorio_integracao_cerebro_sangue.md"]),
    ...
    ("PREPRINT — MANUSCRITO PARA BIORXIV (EN)",
    ...
    ("APÊNDICE A — CÓDIGO-FONTE COMPLETO DOS 16 SCRIPTS DE ANÁLISE",
     ["pipeline/scripts/analise_caso_referencia.py", "pipeline/scripts/analise_gse160208.py",
      ...
      "pipeline/scripts/gera_figuras.py", "pipeline/scripts/gera_figuras_v2.py",
      "pipeline/scripts/coloc_stx6_eqtl.py", "pipeline/scripts/coloc_meta_stx6.py",
      "pipeline/scripts/clumping_descoberta.py",
      "pipeline/scripts/analise_integrada_cerebro_sangue.py"]),
]
